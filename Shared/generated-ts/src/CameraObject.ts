...
import type { CameraKind } from "./CameraKind";
 ...
 */
export type CameraObject = { cameraKind: CameraKind, 
/**
 ...
 */
zoom: number, near?: number, far?: number, target?: Vec3, 
/**
 * Up vector. Absent means +Y.
 */
up?: Vec3, id: string, name: string, visible: boolean, locked: boolean, 
/**
 * 0–1.
 */
opacity: number, 
