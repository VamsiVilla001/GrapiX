...
const outfile = path.join(packageRoot, "dist", "bundle", "grapix-editor-assistant.mjs");
...
process.stdout.write(
  `[editor-assistant] bundled ${path.relative(packageRoot, outfile)} — ${(size / 1024).toFixed(0)} KiB\n`
);
